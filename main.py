...
model = unet(args.lossfunction, args.optimizer, 1e-4)
dirpath = '/scratch/tmp/m_kais13/checkpoints'
os.makedirs(dirpath, exist_ok=True)
filename = 's{0}_bs{1}_lf{2}_opt{3}_lr{4}.h5'.format(args.steps,args.batchsize,args.lossfunction,args.optimizer,"1e-4")
