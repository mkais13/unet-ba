...
cb_checkpointer = ModelCheckpoint(filepath = os.path.join(dirpath, 's{args.steps}_bs{args.batchsize}_lf{args.lossfunction}.h5'), monitor = 'loss', save_best_only = False, mode = 'auto', verbose=1)
